...
export class TablaMainJuridicoComponent implements OnInit {
  ...
  openVerifVirtual(NoQueja, strQueja) {
	  ...
	  const dialogConfig = new MatDialogConfig();
		...
		dialogConfig.data = {NoQueja: NoQueja, quejanumero: strQueja, Rol: this._submitFormService.Get_Juridico(), Usuario: this._submitFormService.Get_userid()};
  ...
  openBitacora(NoQueja, strQueja, flujo) {
	  ...
	  const dialogConfig = new MatDialogConfig();
		...
		dialogConfig.width = '1200px';
		dialogConfig.data = {NoQueja: NoQueja, quejanumero: strQueja, Rol: this._submitFormService.Get_Juridico(), Usuario: this._submitFormService.Get_userid(), Flujo: flujo};
	...
	openListadoArchivos(NoQueja, strQueja, flujo) {
	  ...
	  const dialogConfig = new MatDialogConfig();
		...
		dialogConfig.height = '800px';
		dialogConfig.width = '1000px';
		dialogConfig.data = {NoQueja: NoQueja, quejanumero: strQueja, Rol: this._submitFormService.Get_Atencion_Consumidor(), Usuario: this._submitFormService.Get_userid(), Flujo: flujo};
